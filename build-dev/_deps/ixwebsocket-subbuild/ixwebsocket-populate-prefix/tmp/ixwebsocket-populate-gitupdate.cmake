...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v11.4.5"
  WORKING_DIRECTORY "/home/slipnut44/git_repo/group45/build-dev/_deps/ixwebsocket-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/slipnut44/git_repo/group45/build-dev/_deps/ixwebsocket-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/slipnut44/git_repo/group45/build-dev/_deps/ixwebsocket-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
